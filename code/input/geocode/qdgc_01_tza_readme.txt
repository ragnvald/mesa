...
The files in this folder covers such tiles for Tanzania on what is 
referred to as level 1. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_01_tza.dbf   Attribute file
qdgc_01_tza.prj   Projection file
qdgc_01_tza.shp   Spatial data file (shapefile)
qdgc_01_tza.shx   Index file
