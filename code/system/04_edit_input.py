...
def build_start_tab(parent):
    ...
    def do_save_gpkg_parquet():
        ...
        messagebox.showinfo("Saved", "Saved asset-group layer + profile to GPKG & GeoParquet (and JSON).")
...
if __name__ == "__main__":
    ...
    # Load profiles (ENV only; GPKG -> Parquet -> JSON -> defaults), then mirror to all
